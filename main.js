...
`;t.ContextMenuItem=e=>n.createElement(s,Object.assign({},e),e.children),t.ContextMenu=e=>n.createElement(i,Object.assign({},e),e.children)},8042:(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.CreateSimulationForm=void 0;const n=r(7294),o=r(7294),i=r(4282),s=r(2718),a=r(176),l=r(3540),c=r(3229),u=r(9906),d=r(1139),h=r(4579),m=[{label:"None",value:i.GridLoopType.NONE},{label:"Torus",value:i.GridLoopType.TORUS},{label:"Horizontal",value:i.GridLoopType.HORIZONTAL},{label:"Vertical",value:i.GridLoopType.VERTICAL}];t.CreateSimulationForm=({options:e})=>{const t=(0,o.useContext)(s.RootStoreContext),[r,i]=(0,o.useState)(e.loop),[g,p]=(0,o.useState)(e.width),[f,v]=(0,o.useState)(e.height),[y,b]=(0,o.useState)(e.initialEnergy),[E,O]=(0,o.useState)(e.population),[C,x]=(0,o.useState)(e.lightDepth),[S,R]=(0,o.useState)(e.lightGradient),[w,M]=(0,o.useState)(e.mineralsDepth),[I,P]=(0,o.useState)(e.mineralsGradient);return n.createElement(n.Fragment,null,n.createElement(l.FormRow,{label:"Grid width"},n.createElement(c.NumberInput,{min:0,onChange:e=>p(e),value:g})),n.createElement(l.FormRow,{label:"Grid height"},n.createElement(c.NumberInput,{min:0,onChange:e=>v(e),value:f})),n.createElement(l.FormRow,{label:"Loop"},n.createElement(d.Select,{onSelect:e=>i(e),options:m,value:r})),n.createElement(u.RangeRow,{label:"Population",postfix:"%",min:0,max:100,step:.1,onChange:e=>O(e),value:E}),n.createElement(u.RangeRow,{label:"Initial energy",min:0,max:100,step:1,onChange:e=>b(e),value:y}),n.createElement(u.RangeRow,{label:"Light depth",postfix:"%",min:0,max:100,step:.1,onChange:e=>x(e),value:C}),n.createElement(h.Switch,{label:"Light gradient",value:S,onChange:e=>R(e)}),n.createElement(u.RangeRow,{label:"Minerals depth",postfix:"%",min:0,max:100,step:.1,onChange:e=>M(e),value:w}),n.createElement(h.Switch,{label:"Minerals gradient",value:I,onChange:e=>P(e)}),n.createElement(a.Button,{apperance:"primary",width:"100%",onClick:()=>{t.newSimulation({loop:r,width:g,height:f,initialEnergy:y,population:E,lightDepth:C,lightGradient:S,mineralsDepth:w,mineralsGradient:I})}},"Create"))}},176:(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.Button=void 0;const n=r(2766),o=r(7294),i=r(8804),s=r(23),a={primary:{backgroundColor:s.THEME.primary,boderColor:s.THEME.primary,textColor:s.THEME.color},success:{backgroundColor:s.THEME.success,boderColor:s.THEME.success,textColor:s.THEME.color},secondary:{backgroundColor:s.THEME.secondary,boderColor:s.THEME.secondary,textColor:s.THEME.color}},l=i.default.button`
    border: 1px solid;
    border-radius: 10px;
    cursor: pointer;
    padding: 10px 16px;
...
`,x=(0,o.default)(c.ToolbarItem)`
    ...
    padding: 0;
    gap: 0;
`,S=[{label:"Square",value:b.BrushType.SQUARE},{label:"Circle",value:b.BrushType.CIRCLE}],R=[{label:"Empty",value:y.CellType.EMPTY},{label:"Wall",value:y.CellType.WALL},{label:"Organic",value:y.CellType.ORGANIC},{label:"Organism",value:y.CellType.ORGANISM}];t.PaintModeItem=(0,i.observer)((()=>{const{renderer:e}=(0,s.useContext)(E.SimulationContext),t=e.getPaintMode(),[r,o]=(0,s.useState)(!1),i=(0,s.useRef)();return n.createElement("div",{ref:i},n.createElement(x,{focused:r,enabled:t.isEnabled()},n.createElement(C,{onClick:()=>t.setEnabled(!t.isEnabled())},n.createElement(l.FontAwesomeIcon,{icon:a.faPaintbrush})),n.createElement(O,{onClick:()=>{o(!r),!t.isEnabled()&&t.setEnabled(!0)}},n.createElement(l.FontAwesomeIcon,{icon:u.faCaretDown}))),r&&n.createElement(d.Overflow,{root:i.current,onLoseFocus:()=>o(!1)},n.createElement(h.ContextMenu,null,n.createElement(g.FormRow,{label:"Type of paint"},n.createElement(m.RadioGroup,{choices:R,value:t.getType(),onChange:e=>t.setType(e)})),n.createElement(g.FormRow,{label:"Brush shape"},n.createElement(m.RadioGroup,{choices:S,value:t.getBrush(),onChange:e=>t.setBrush(e)})),n.createElement(g.FormRow,{label:"Ignore"},R.map(((e,r)=>n.createElement(f.Checkbox,{key:r,label:e.label,checked:t.isIgnore(e.value),onChange:r=>r?t.addIgnore(e.value):t.removeIgnore(e.value)})))),n.createElement(p.RangeRow,{label:"Brush size",min:1,max:20,step:1,onChange:e=>t.setSize(e),value:t.getSize()}),n.createElement(v.Button,{onClick:()=>t.clearClipboard()},"Reset clipboard"))))}))},2742:(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.ParametersItem=void 0;const n=r(7294),o=r(2766),i=r(7294),s=r(7810),a=r(7625),l=r(8421),c=r(157),u=r(7244);t.ParametersItem=(0,o.observer)((()=>{const{ui:e}=(0,i.useContext)(u.SimulationContext);return n.createElement(l.ToolbarItem,{onClick:()=>e.toggleTab(c.SidebarTab.PARAMERS),enabled:e.isTabActive(c.SidebarTab.PARAMERS)},n.createElement(a.FontAwesomeIcon,{icon:s.faCogs}))}))},2384:(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.RenderModeItem=void 0;const n=r(7294),o=r(8804),i=r(2766),s=r(7294),a=r(446),l=r(7625),c=r(8421),u=r(1421),d=r(5912),h=r(1752),m=r(1522),g=r(7244),p=o.default.div`
    margin-left: 5px;
