...
`,I=d.default.div`
    display: flex;
    gap: 5px;
`,_=(0,o.observer)((({item:e})=>{const[t,n]=(0,s.useState)(!1),o=(0,s.useContext)(i.GenomeBankContext);if(t){const t=t=>{e.setName(t),o.put(e),n(!1)};return r.createElement(P,{value:e.getName(),onSave:t,onCancel:()=>n(!1)})}return e.getName().length>0?r.createElement(b,{onClick:()=>n(!0)},e.getName()):r.createElement(E,{onClick:()=>n(!0)},"No description.")})),P=(0,o.observer)((({value:e,onSave:t,onCancel:n})=>{const[o,i]=(0,s.useState)(e);return r.createElement(S,null,r.createElement(p.Textarea,{value:o,onChange:e=>i(e),placeholder:"Short description of this genome"}),r.createElement(I,null,r.createElement(g.Button,{width:"100%",apperance:"primary",onClick:()=>t(o)},"Save"),r.createElement(g.Button,{width:"100%",apperance:"secondary",onClick:()=>n()},"Cancel")))}));t.Item=(0,o.observer)((({item:e})=>{const t=(0,s.useContext)(i.GenomeBankContext);return r.createElement(y,null,r.createElement(O,null,r.createElement(C,null,r.createElement(m.Visualization,{genome:e.getGenome()})),r.createElement(x,null,r.createElement(w,{onClick:()=>{!function(e){const t=document.createElement("a"),n=window.URL.createObjectURL(new Blob([JSON.stringify(e.serialize())],{type:"octet/stream"}));t.href=n,t.setAttribute("download",e.getId()+".genome"),t.click(),window.URL.revokeObjectURL(n)}(e)}},r.createElement(h.FontAwesomeIcon,{icon:a.faDownload})),r.createElement(w,{onClick:()=>{t.delete(e)}},r.createElement(h.FontAwesomeIcon,{icon:l.faTrash})))),r.createElement(_,{item:e}))})),t.Genomes=(0,o.observer)((()=>{(0,s.useContext)(i.SimulationContext);const e=(0,s.useContext)(i.GenomeBankContext);return r.createElement(r.Fragment,null,r.createElement(v,null,r.createElement(M,{apperance:"primary",onClick:()=>(()=>{const t=document.createElement("input");t.type="file",t.addEventListener("change",(n=>{for(const n of t.files)n.text().then((t=>{try{const n=JSON.parse(t);e.put(new f.GenomeItem(n.name,n.id,n.genome,+Date.now()))}catch(e){alert("File parsing error")}}))})),t.click()})()},r.createElement(h.FontAwesomeIcon,{icon:u.faUpload})," Import"),r.createElement(g.Button,{onClick:()=>e.refresh()},r.createElement(h.FontAwesomeIcon,{icon:c.faRotate}))),r.createElement(r.Fragment,null,e.getItems().map((e=>r.createElement(t.Item,{item:e,key:e.getId()})))))}))},4485:(e,t,n)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.Info=void 0;const r=n(7294),o=n(2766),i=n(1997),s=n(7294),a=n(8804),l=n(6724),c=a.default.div`
    display: flex;
    justify-content: space-between;
    margin-bottom: 6px;
...
`,b=o.default.div`
    ...
    align-items: center;
    padding: 0 5px;
`,E=(0,o.default)(u.ToolbarItem)`
    align-items: stretch;
    padding: 0;
    gap: 0;
`,O=[{label:"Square",value:"square"},{label:"Circle",value:"circle"}],C=[{label:"Empty",value:"empty"},{label:"Wall",value:"wall"},{label:"Organic",value:"organic"},{label:"Organism",value:"organism"}];t.PaintModeItem=(0,i.observer)((({})=>{const e=(0,s.useContext)(c.SimulationContext).getRenderer().getPaintMode(),[t,n]=(0,s.useState)(!1),o=(0,s.useRef)();return r.createElement("div",{ref:o},r.createElement(E,{focused:t,enabled:e.isEnabled()},r.createElement(b,{onClick:()=>e.setEnabled(!e.isEnabled())},r.createElement(l.FontAwesomeIcon,{icon:a.faPaintbrush})),r.createElement(y,{onClick:()=>{n(!t),!e.isEnabled()&&e.setEnabled(!0)}},r.createElement(l.FontAwesomeIcon,{icon:d.faCaretDown}))),t&&r.createElement(h.Overflow,{root:o.current,onLoseFocus:()=>n(!1)},r.createElement(m.ContextMenu,null,r.createElement(p.FormRow,{label:"Type of paint"},r.createElement(g.RadioGroup,{choices:C,value:e.getType(),onChange:t=>e.setType(t)})),r.createElement(p.FormRow,{label:"Brush shape"},r.createElement(g.RadioGroup,{choices:O,value:e.getBrush(),onChange:t=>e.setBrush(t)})),r.createElement(p.FormRow,{label:"Ignore"},C.map(((t,n)=>r.createElement(v.Checkbox,{key:n,label:t.label,checked:e.isIgnore(t.value),onChange:n=>n?e.addIgnore(t.value):e.removeIgnore(t.value)})))),r.createElement(f.RangeRow,{label:"Brush size",min:1,max:20,step:1,onChange:t=>e.setSize(t),value:e.getSize()}))))}))},2742:(e,t,n)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.ParametersItem=void 0;const r=n(7294),o=n(2766),i=n(7294),s=n(7810),a=n(7625),l=n(1997),c=n(8421),u=n(789);t.ParametersItem=(0,o.observer)((({})=>{const e=(0,i.useContext)(l.SimulationContext).getUI();return r.createElement(c.ToolbarItem,{onClick:()=>e.toggleTab(u.SidebarTab.PARAMERS),enabled:e.isTabActive(u.SidebarTab.PARAMERS)},r.createElement(a.FontAwesomeIcon,{icon:s.faCogs}))}))},2384:(e,t,n)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.RenderModeItem=void 0;const r=n(7294),o=n(8804),i=n(2766),s=n(7294),a=n(446),l=n(7625),c=n(1997),u=n(8421),d=n(1421),h=n(5912),m=n(1752),g=n(1522),p=o.default.div`
    margin-left: 5px;
