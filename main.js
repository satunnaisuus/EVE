...
`;t.MouthOrgan=(0,o.observer)((({direction:e})=>n.createElement(a,{direction:e},n.createElement("img",{src:s.default}))))},5498:(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.OxidizerOrgan=void 0;const n=r(7294),o=r(2766),i=r(8804),s=r(3552),a=i.default.div`
    ...
    transform: rotate(${({direction:e})=>45*e}deg);
    z-index: 3;
`;t.OxidizerOrgan=(0,o.observer)((({direction:e})=>n.createElement(a,{direction:e},n.createElement("img",{src:s.default}))))},7971:(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.SpineOrgan=void 0;const n=r(7294),o=r(2766),i=r(8804),s=r(4242),a=i.default.div`
    width: 46px;
    height: 32px;
    position: absolute; 
    left: 0; 
...
`,p=i.default.div`
    ...
    text-align: center;
`;t.Program=(0,o.observer)((({organism:e})=>n.createElement(a,null,n.createElement(l,null,"Program"),n.createElement(c,null,e.genome.program.map(((t,r)=>n.createElement(u,{key:r},n.createElement(d,{active:r===e.programCounter},r),n.createElement(h,null,s.Command[t.code],"(",t.args.map(((e,r)=>n.createElement("span",{key:r},n.createElement(p,{title:e.toString()},e),t.args.length-1===r?"":", "))),")",t.branches.map(((e,t)=>n.createElement(m,{key:t},e)))))))))))},5159:(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.Visualization=void 0;const n=r(7294),o=r(8804),i=r(2766),s=r(2841),a=r(346),l=r(3798),c=r(2920),u=r(1098),d=r(5498),h=r(7971),m=r(6373),p=r(5160),g=o.default.div`
    width: 200px;
    height: 200px;
    position: relative;
    margin: 0 auto;
`;t.Visualization=(0,i.observer)((({genome:e})=>n.createElement(g,null,n.createElement(a.Body,{color:e.color}),e.organs.map(((e,t)=>{switch(e){case s.Organ.ARMOUR:return n.createElement(l.ArmorOrgan,{key:t,direction:t});case s.Organ.FIN:return n.createElement(c.FinOrgan,{key:t,direction:t});case s.Organ.MOUTH:return n.createElement(u.MouthOrgan,{key:t,direction:t});case s.Organ.OXIDIZER:return n.createElement(d.OxidizerOrgan,{key:t,direction:t});case s.Organ.SPINE:return n.createElement(h.SpineOrgan,{key:t,direction:t});case s.Organ.CHLOROPLAST:return n.createElement(m.ChloroplastOrgan,{key:t,direction:t});case s.Organ.EYE:return n.createElement(p.EyeOrgan,{key:t,direction:t})}})))))},8005:(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.UnselectedCell=void 0;const n=r(7294),o=r(2766);t.UnselectedCell=(0,o.observer)((()=>n.createElement(n.Fragment,null,"Select a cell on the map")))},1752:(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.ContextMenu=t.ContextMenuItem=void 0;const n=r(7294),o=r(8804),i=o.default.div`
    display: flex;
    flex-direction: column;
    background: #202c3c;
    margin-top: 10px;
...
`;t.ContextMenuItem=e=>n.createElement(s,Object.assign({},e),e.children),t.ContextMenu=e=>n.createElement(i,Object.assign({},e),e.children)},8042:(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.CreateSimulationForm=void 0;const n=r(7294),o=r(7294),i=r(4282),s=r(2718),a=r(176),l=r(3540),c=r(3229),u=r(9906),d=r(1139),h=r(4579),m=[{label:"None",value:i.GridLoopType.NONE},{label:"Torus",value:i.GridLoopType.TORUS},{label:"Horizontal",value:i.GridLoopType.HORIZONTAL},{label:"Vertical",value:i.GridLoopType.VERTICAL}];t.CreateSimulationForm=({options:e})=>{const t=(0,o.useContext)(s.RootStoreContext),[r,i]=(0,o.useState)(e.loop),[p,g]=(0,o.useState)(e.width),[f,v]=(0,o.useState)(e.height),[y,b]=(0,o.useState)(e.initialEnergy),[E,C]=(0,o.useState)(e.population),[O,x]=(0,o.useState)(e.lightDepth),[S,w]=(0,o.useState)(e.lightGradient),[M,I]=(0,o.useState)(e.mineralsDepth),[R,P]=(0,o.useState)(e.mineralsGradient);return n.createElement(n.Fragment,null,n.createElement(l.FormRow,{label:"Grid width"},n.createElement(c.NumberInput,{min:0,onChange:e=>g(e),value:p})),n.createElement(l.FormRow,{label:"Grid height"},n.createElement(c.NumberInput,{min:0,onChange:e=>v(e),value:f})),n.createElement(l.FormRow,{label:"Loop"},n.createElement(d.Select,{onSelect:e=>i(e),options:m,value:r})),n.createElement(u.RangeRow,{label:"Population",postfix:"%",min:0,max:100,step:.1,onChange:e=>C(e),value:E}),n.createElement(u.RangeRow,{label:"Initial energy",min:0,max:100,step:1,onChange:e=>b(e),value:y}),n.createElement(u.RangeRow,{label:"Light depth",postfix:"%",min:0,max:100,step:.1,onChange:e=>x(e),value:O}),n.createElement(h.Switch,{label:"Light gradient",value:S,onChange:e=>w(e)}),n.createElement(u.RangeRow,{label:"Minerals depth",postfix:"%",min:0,max:100,step:.1,onChange:e=>I(e),value:M}),n.createElement(h.Switch,{label:"Minerals gradient",value:R,onChange:e=>P(e)}),n.createElement(a.Button,{apperance:"primary",width:"100%",onClick:()=>{t.newSimulation({loop:r,width:p,height:f,initialEnergy:y,population:E,lightDepth:O,lightGradient:S,mineralsDepth:M,mineralsGradient:R})}},"Create"))}},176:(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.Button=void 0;const n=r(2766),o=r(7294),i=r(8804),s=r(23),a={primary:{backgroundColor:s.THEME.primary,boderColor:s.THEME.primary,textColor:s.THEME.color},success:{backgroundColor:s.THEME.success,boderColor:s.THEME.success,textColor:s.THEME.color},secondary:{backgroundColor:s.THEME.secondary,boderColor:s.THEME.secondary,textColor:s.THEME.color}},l=i.default.button`
    border: 1px solid;
    border-radius: 10px;
    cursor: pointer;
    padding: 10px 16px;
...
`,h=o.default.div`
    ...
    top: 11px;
    right: 10px;
`;t.NumberInput=e=>{const[t,r]=n.useState(e.value||0),o=t=>{void 0!==e.min&&t<e.min&&(t=e.min),void 0!==e.max&&t>e.max&&(t=e.max),r(t),e.onChange(t)};let m=n.createElement(c,{onClick:()=>o(t-1)},n.createElement(a.FontAwesomeIcon,{icon:i.faMinus})),p=n.createElement(c,{onClick:()=>o(t+1)},n.createElement(a.FontAwesomeIcon,{icon:s.faPlus}));return void 0!==e.min&&e.value<=e.min&&(m=n.createElement(u,null,n.createElement(a.FontAwesomeIcon,{icon:i.faMinus}))),void 0!==e.max&&e.value>=e.max&&(p=n.createElement(u,null,n.createElement(a.FontAwesomeIcon,{icon:s.faPlus}))),n.createElement(d,null,n.createElement(l,{type:"text",value:t,onChange:e=>(e=>{const t=Number(e);o(Number.isSafeInteger(t)?t:0)})(e.target.value)}),n.createElement(h,null,m,p))}},1522:(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.RadioGroup=void 0;const n=r(8055),o=r(7625),i=r(7294),s=r(8804),a=s.default.div`
...
`;t.Switch=e=>n.createElement(i,null,n.createElement(s,{type:"checkbox",checked:e.value,onChange:t=>e.onChange(t.target.checked)}),n.createElement(a,null),n.createElement(l,null,e.label))},4070:(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.Textarea=void 0;const n=r(7294),o=r(8804).default.textarea`
    ...
    border-radius: 10px;
    color: ${e=>e.theme.color};
`;t.Textarea=({value:e,onChange:t,placeholder:r})=>n.createElement(o,{onChange:e=>t(e.target.value),value:e,placeholder:r})},617:(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.Genomes=t.Item=void 0;const n=r(7294),o=r(2766),i=r(7294),s=r(767),a=r(2619),l=r(4227),c=r(7608),u=r(2723),d=r(8804),h=r(7625),m=r(5159),p=r(176),g=r(4070),f=r(1065),v=r(2841),y=r(2718),b=d.default.div`
    display: flex;
    margin-bottom: 10px;
    gap: 5px;
`,E=d.default.div`
...
`,w=d.default.div`
    ...
    flex-direction: column;
    gap: 5px;
`,M=(0,d.default)(p.Button)`
    padding: 8px 10px;
`,I=(0,d.default)(p.Button)`
    flex-grow: 1;
`,R=d.default.div`
    display: flex;
    flex-direction: column;
...
`,P=d.default.div`
    display: flex;
    gap: 5px;
`,T=(0,o.observer)((({item:e})=>{const[t,r]=(0,i.useState)(!1),o=(0,i.useContext)(y.RootStoreContext).getGenomeStore();if(t){const t=t=>{e.setName(t),o.put(e),r(!1)};return n.createElement(_,{value:e.getName(),onSave:t,onCancel:()=>r(!1)})}return e.getName().length>0?n.createElement(C,{onClick:()=>r(!0)},e.getName()):n.createElement(O,{onClick:()=>r(!0)},"No description.")})),_=(0,o.observer)((({value:e,onSave:t,onCancel:r})=>{const[o,s]=(0,i.useState)(e);return n.createElement(R,null,n.createElement(g.Textarea,{value:o,onChange:e=>s(e),placeholder:"Short description of this genome"}),n.createElement(P,null,n.createElement(p.Button,{width:"100%",apperance:"primary",onClick:()=>t(o)},"Save"),n.createElement(p.Button,{width:"100%",apperance:"secondary",onClick:()=>r()},"Cancel")))}));t.Item=(0,o.observer)((({item:e})=>{const t=(0,i.useContext)(y.RootStoreContext),r=t.getGenomeStore(),o=t.getSimulationStore().getRendererStore().getPaintMode();return n.createElement(E,null,n.createElement(x,null,n.createElement(S,null,n.createElement(m.Visualization,{genome:e.getGenome()})),n.createElement(w,null,n.createElement(M,{onClick:()=>{o.setClipboard(e.getGenome()),o.setType(v.CellType.ORGANISM),o.setEnabled(!0)}},n.createElement(h.FontAwesomeIcon,{icon:l.faEyeDropper})),n.createElement(M,{onClick:()=>{!function(e){const t=document.createElement("a"),r=window.URL.createObjectURL(new Blob([JSON.stringify(e.serialize())],{type:"octet/stream"}));t.href=r,t.setAttribute("download",e.getId()+".genome"),t.click(),window.URL.revokeObjectURL(r)}(e)}},n.createElement(h.FontAwesomeIcon,{icon:s.faDownload})),n.createElement(M,{onClick:()=>{r.delete(e)}},n.createElement(h.FontAwesomeIcon,{icon:a.faTrash})))),n.createElement(T,{item:e}))})),t.Genomes=(0,o.observer)((()=>{const e=(0,i.useContext)(y.RootStoreContext).getGenomeStore();return n.createElement(n.Fragment,null,n.createElement(b,null,n.createElement(I,{apperance:"primary",onClick:()=>(()=>{const t=document.createElement("input");t.type="file",t.addEventListener("change",(()=>{for(const r of t.files)r.text().then((t=>{try{const r=JSON.parse(t);e.put(new f.GenomeItem(r.name,r.id,r.genome,+Date.now()))}catch(e){alert("File parsing error")}}))})),t.click()})()},n.createElement(h.FontAwesomeIcon,{icon:u.faUpload})," Import"),n.createElement(p.Button,{onClick:()=>e.refresh()},n.createElement(h.FontAwesomeIcon,{icon:c.faRotate}))),n.createElement(n.Fragment,null,e.getItems().map((e=>n.createElement(t.Item,{item:e,key:e.getId()})))))}))},4485:(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.Info=void 0;const n=r(7294),o=r(2766),i=r(7294),s=r(8804),a=r(6724),l=r(7244),c=s.default.div`
    display: flex;
    justify-content: space-between;
    margin-bottom: 6px;
...
`,f=o.default.div`
    ...
    width: 320px;
`;t.Overlay=(0,i.observer)((()=>{const{ui:e}=(0,a.useContext)(m.SimulationContext);return n.createElement(p,null,e.isInfoOpened()&&n.createElement(g,null,n.createElement(l.Info,null)),e.isTabActive(u.SidebarTab.PARAMERS)&&n.createElement(f,null,n.createElement(s.Parameters,null)),e.isTabActive(u.SidebarTab.CELL)&&n.createElement(f,null,n.createElement(c.SelectedCell,null)),e.isTabActive(u.SidebarTab.GENOMES)&&n.createElement(f,null,n.createElement(d.Genomes,null)),e.isTabActive(u.SidebarTab.SAVES)&&n.createElement(f,null,n.createElement(h.Saves,null)))}))},1936:(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.Parameters=void 0;const n=r(7294),o=r(2766),i=r(7294),s=r(9906),a=r(7244);t.Parameters=(0,o.observer)((()=>{const{parameters:e}=(0,i.useContext)(a.SimulationContext);return n.createElement(n.Fragment,null,n.createElement(s.RangeRow,{label:"Lifetime limit",min:1,max:255,step:1,onChange:t=>e.setOrganismMaxLifetime(t),value:e.getOrganismMaxLifetime()}),n.createElement(s.RangeRow,{label:"Photosynthesis energy",min:0,max:255,step:1,onChange:t=>e.setPhotosynthesisEnergy(t),value:e.getPhotosynthesisEnergy()}),n.createElement(s.RangeRow,{label:"Chemosynthesis energy",min:0,max:255,step:1,onChange:t=>e.setChemosynthesisEnergy(t),value:e.getChemosynthesisEnergy()}),n.createElement(s.RangeRow,{label:"Mutation chance",min:0,max:100,step:1,onChange:t=>e.setMutationChance(t),value:e.getMutationChance()}))}))},2821:function(e,t,r){var n=this&&this.__awaiter||function(e,t,r,n){return new(r||(r=Promise))((function(o,i){function s(e){try{l(n.next(e))}catch(e){i(e)}}function a(e){try{l(n.throw(e))}catch(e){i(e)}}function l(e){var t;e.done?o(e.value):(t=e.value,t instanceof r?t:new r((function(e){e(t)}))).then(s,a)}l((n=n.apply(e,t||[])).next())}))};Object.defineProperty(t,"__esModule",{value:!0}),t.Saves=t.Item=void 0;const o=r(7294),i=r(8804),s=r(2766),a=r(7294),l=r(767),c=r(2619),u=r(7608),d=r(2723),h=r(7625),m=r(176),p=r(4025),g=r(2718),f=i.default.div`
    display: flex;
    margin-bottom: 10px;
    gap: 5px;
`,v=i.default.div`
...
`,E=(0,i.default)(m.Button)`
    padding: 8px 10px;
`,C=(0,i.default)(m.Button)`
    flex-grow: 1;
`;t.Item=(0,s.observer)((({item:e})=>{const t=(0,a.useContext)(g.RootStoreContext),r=t.getSaveStore();return o.createElement(v,null,o.createElement(y,{onClick:()=>n(void 0,void 0,void 0,(function*(){t.loadSimulation(yield r.getDump(e),e.getRenderMode())}))},o.createElement("div",null,new Date(e.getCreatedAt()).toLocaleString()),o.createElement("div",null,"Step: ",e.getStep())),o.createElement(b,null,o.createElement(E,{onClick:()=>{!function(e,t){n(this,void 0,void 0,(function*(){const r=document.createElement("a"),n=window.URL.createObjectURL(new Blob([JSON.stringify(yield t.serialize(e))],{type:"octet/stream"}));r.href=n,r.setAttribute("download",e.getId()+".save"),r.click(),window.URL.revokeObjectURL(n)}))}(e,r)}},o.createElement(h.FontAwesomeIcon,{icon:l.faDownload})),o.createElement(E,{onClick:()=>{r.delete(e)}},o.createElement(h.FontAwesomeIcon,{icon:c.faTrash}))))})),t.Saves=(0,s.observer)((()=>{const e=(0,a.useContext)(g.RootStoreContext),r=e.getSaveStore(),n=e.getSimulationStore(),i=()=>{const e=document.createElement("input");e.type="file",e.addEventListener("change",(()=>{for(const t of e.files)t.text().then((e=>{try{const t=JSON.parse(e);r.addSave(new p.SaveItem(t.id,+Date.now(),t.step,t.renderMode,t.version),t.dump)}catch(e){alert("File parsing error")}}))})),e.click()};return o.createElement(o.Fragment,null,o.createElement(f,null,!e.getSimulationStore()&&o.createElement(o.Fragment,null,o.createElement(C,{apperance:"primary",onClick:()=>i()},o.createElement(h.FontAwesomeIcon,{icon:d.faUpload})," Import")),e.getSimulationStore()&&o.createElement(o.Fragment,null,o.createElement(C,{apperance:"primary",onClick:()=>n.save()},"Save"),o.createElement(m.Button,{onClick:()=>i()},o.createElement(h.FontAwesomeIcon,{icon:d.faUpload}))),o.createElement(m.Button,{onClick:()=>r.refresh()},o.createElement(h.FontAwesomeIcon,{icon:u.faRotate}))),o.createElement(o.Fragment,null,r.getItems().map((e=>o.createElement(t.Item,{item:e,key:e.getId()})))))}))},8477:(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.SelectedCell=void 0;const n=r(7294),o=r(2766),i=r(7294),s=r(8360),a=r(8005),l=r(2841),c=r(7244);t.SelectedCell=(0,o.observer)((()=>{const{selectedCell:e}=(0,i.useContext)(c.SimulationContext),t=e.getCell();return t&&t.type===l.CellType.ORGANISM?n.createElement(s.OrganismCell,null):n.createElement(a.UnselectedCell,null)}))},7244:(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.Simulation=t.SimulationContext=void 0;const n=r(7294),o=r(8804),i=r(2766),s=r(4924),a=r(6852),l=r(7999),c=r(7294),u=o.default.div`
    height: 100%;
    width: 100%;
    display: flex;
    flex-direction: column;
    position: relative;
`;t.SimulationContext=(0,c.createContext)({simulation:null,ui:null,renderer:null,selectedCell:null,parameters:null}),t.Simulation=(0,i.observer)((({simulation:e})=>{const r={simulation:e,ui:e.getUI(),renderer:e.getRendererStore(),selectedCell:e.getSelectedCell(),parameters:e.getParameters()};return n.createElement(t.SimulationContext.Provider,{value:r},e.isReady()&&n.createElement(u,null,n.createElement(l.Toolbar,null),n.createElement(a.Overlay,null),n.createElement(s.Viewport,null)))}))},7999:(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.Toolbar=void 0;const n=r(7294),o=r(8804),i=r(2766),s=r(6700),a=r(9008),l=r(2384),c=r(7099),u=r(7382),d=r(2742),h=r(9073),m=r(9697),p=r(2722),g=r(7726),f=o.default.div`
    display: flex;
    align-items: stretch;
    width: 100%;
    overflow-x: auto;
...
`;t.ToolbarItem=(0,o.observer)((e=>n.createElement(i,Object.assign({},e))))},7099:(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.NewSimulationItem=void 0;const n=r(7294),o=r(2766),i=r(7294),s=r(3208),a=r(7625),l=r(8421),c=r(2718);t.NewSimulationItem=(0,o.observer)((()=>{const e=(0,i.useContext)(c.RootStoreContext);return n.createElement(l.ToolbarItem,{onClick:()=>e.closeSimulation()},n.createElement(a.FontAwesomeIcon,{icon:s.faRotateRight}))}))},7382:(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.PaintModeItem=void 0;const n=r(7294),o=r(8804),i=r(2766),s=r(7294),a=r(869),l=r(7625),c=r(8421),u=r(1421),d=r(5912),h=r(1752),m=r(1522),p=r(3540),g=r(9906),f=r(6989),v=r(176),y=r(2841),b=r(7822),E=r(7244),C=o.default.div`
    display: flex;
    align-items: center;
    padding: 0 5px;
