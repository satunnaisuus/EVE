...
`;t.Button=(0,r.observer)((e=>o.createElement(l,Object.assign({},e),e.children)))},8360:(e,t,n)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.OrganismCell=void 0;const r=n(7294),o=n(8804),i=n(8977),s=n(2766),a=n(1997),l=n(7294),c=n(5159),d=n(2841),u=n(5221),h=n(2120),m=n(789),p=n(7625),g=o.default.div`
    display: flex;
...
`,y=o.default.span`
    color: #00ff00;
`,b=(0,o.default)(h.Button)`
    margin-bottom: 10px;
`;t.OrganismCell=(0,s.observer)((()=>{const e=(0,l.useContext)(a.SimulationContext),t=(0,l.useContext)(a.GenomeBankContext),n=e.getSelectedCell(),o=n.getCell();if(o.type===d.CellType.ORGANISM)return r.createElement(r.Fragment,null,r.createElement(f,null,r.createElement("div",null,r.createElement(b,{apperance:"primary",width:"100%",onClick:()=>{t.addGenome(o.genome).then((()=>{e.getUI().setActiveTab(m.SidebarTab.GENOMES)}))}},r.createElement(p.FontAwesomeIcon,{icon:i.faFloppyDisk})," Save genome"),r.createElement(c.Visualization,{genome:o.genome}),r.createElement(g,null,r.createElement("span",null,"Status"),n.isAlive()?r.createElement(y,null,"Alive"):r.createElement(v,null,"Dead")),r.createElement(g,null,r.createElement("span",null,"Energy"),r.createElement("span",null,o.energy)),r.createElement(g,null,r.createElement("span",null,"Lifetime"),r.createElement("span",null,o.lifetime)),r.createElement(g,null,r.createElement("span",null,"Divide limit"),r.createElement("span",null,o.genome.divideLimit)),r.createElement(u.Program,{organism:o}))))}))},346:(e,t,n)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.Body=void 0;const r=n(7294),o=n(2766),i=n(8804).default.div`
    width: 120px;
    height: 120px;
    ...
    border-radius: 100%;
    z-index: 2;
`;t.Body=(0,o.observer)((({color:e})=>r.createElement(i,{color:e})))},3798:(e,t,n)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.ArmorOrgan=void 0;const r=n(7294),o=n(8804),i=n(2500),s=n(2766),a=o.default.div`
    width: 56px;
    height: 12px;
    position: absolute; 
    left: 0; 
    ...
    z-index: 3;
`;t.ArmorOrgan=(0,s.observer)((({direction:e})=>r.createElement(a,{direction:e},r.createElement("img",{src:i.default}))))},6373:(e,t,n)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.ChloroplastOrgan=void 0;const r=n(7294),o=n(2766),i=n(8804),s=n(7308),a=i.default.div`
    width: 22px;
    height: 22px;
    position: absolute; 
    left: 0; 
...
`,p=i.default.div`
    ...
    text-align: center;
`;t.Program=(0,o.observer)((({organism:e})=>r.createElement(a,null,r.createElement(l,null,"Program"),r.createElement(c,null,e.genome.program.map(((t,n)=>r.createElement(d,{key:n},r.createElement(u,{active:n===e.programCounter},n),r.createElement(h,null,s.Command[t.code],"(",t.args.map(((e,n)=>r.createElement("span",{key:n},r.createElement(p,{title:e.toString()},e),t.args.length-1===n?"":", "))),")",t.branches.map(((e,t)=>r.createElement(m,{key:t},e)))))))))))},5159:(e,t,n)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.Visualization=void 0;const r=n(7294),o=n(8804),i=n(2766),s=n(2841),a=n(346),l=n(3798),c=n(2920),d=n(1098),u=n(5498),h=n(7971),m=n(6373),p=n(5160),g=o.default.div`
    width: 200px;
    height: 200px;
    position: relative;
    margin: 0 auto;
`;t.Visualization=(0,i.observer)((({genome:e})=>r.createElement(g,null,r.createElement(a.Body,{color:e.color}),e.organs.map(((e,t)=>{switch(e){case s.Organ.ARMOUR:return r.createElement(l.ArmorOrgan,{key:t,direction:t});case s.Organ.FIN:return r.createElement(c.FinOrgan,{key:t,direction:t});case s.Organ.MOUTH:return r.createElement(d.MouthOrgan,{key:t,direction:t});case s.Organ.OXIDIZER:return r.createElement(u.OxidizerOrgan,{key:t,direction:t});case s.Organ.SPINE:return r.createElement(h.SpineOrgan,{key:t,direction:t});case s.Organ.CHLOROPLAST:return r.createElement(m.ChloroplastOrgan,{key:t,direction:t});case s.Organ.EYE:return r.createElement(p.EyeOrgan,{key:t,direction:t})}})))))},8005:(e,t,n)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.UnselectedCell=void 0;const r=n(7294),o=n(2766);t.UnselectedCell=(0,o.observer)((()=>r.createElement(r.Fragment,null,"Select a cell on the map")))},1752:(e,t,n)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.ContextMenu=t.ContextMenuItem=void 0;const r=n(7294),o=n(8804),i=o.default.div`
    display: flex;
    flex-direction: column;
    background: #202c3c;
    margin-top: 10px;
...
`;t.ContextMenuItem=e=>r.createElement(s,Object.assign({},e),e.children),t.ContextMenu=e=>r.createElement(i,Object.assign({},e),e.children)},8042:(e,t,n)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.CreateSimulationForm=void 0;const r=n(7294),o=n(7294),i=n(4282),s=n(1997),a=n(2120),l=n(3540),c=n(3229),d=n(9906),u=n(1139),h=n(4579),m=[{label:"None",value:i.GridLoopType.NONE},{label:"Torus",value:i.GridLoopType.TORUS},{label:"Horizontal",value:i.GridLoopType.HORIZONTAL},{label:"Vertical",value:i.GridLoopType.VERTICAL}];t.CreateSimulationForm=({options:e})=>{const t=(0,o.useContext)(s.AppContext),[n,i]=(0,o.useState)(e.loop),[p,g]=(0,o.useState)(e.width),[f,v]=(0,o.useState)(e.height),[y,b]=(0,o.useState)(e.initialEnergy),[E,C]=(0,o.useState)(e.population),[O,x]=(0,o.useState)(e.lightDepth),[w,S]=(0,o.useState)(e.lightGradient),[M,I]=(0,o.useState)(e.mineralsDepth),[R,P]=(0,o.useState)(e.mineralsGradient);return r.createElement(r.Fragment,null,r.createElement(l.FormRow,{label:"Grid width"},r.createElement(c.NumberInput,{min:0,onChange:e=>g(e),value:p})),r.createElement(l.FormRow,{label:"Grid height"},r.createElement(c.NumberInput,{min:0,onChange:e=>v(e),value:f})),r.createElement(l.FormRow,{label:"Loop"},r.createElement(u.Select,{onSelect:e=>i(e),options:m,value:n})),r.createElement(d.RangeRow,{label:"Population",postfix:"%",min:0,max:100,step:.1,onChange:e=>C(e),value:E}),r.createElement(d.RangeRow,{label:"Initial energy",min:0,max:100,step:1,onChange:e=>b(e),value:y}),r.createElement(d.RangeRow,{label:"Light depth",postfix:"%",min:0,max:100,step:.1,onChange:e=>x(e),value:O}),r.createElement(h.Switch,{label:"Light gradient",value:w,onChange:e=>S(e)}),r.createElement(d.RangeRow,{label:"Minerals depth",postfix:"%",min:0,max:100,step:.1,onChange:e=>I(e),value:M}),r.createElement(h.Switch,{label:"Minerals gradient",value:R,onChange:e=>P(e)}),r.createElement(a.Button,{apperance:"primary",width:"100%",onClick:()=>{t.newSimulation({loop:n,width:p,height:f,initialEnergy:y,population:E,lightDepth:O,lightGradient:w,mineralsDepth:M,mineralsGradient:R})}},"Create"))}},2197:(e,t,n)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.Flex=void 0;const r=n(7294),o=n(8804).default.div`
    display: flex;
...
`,h=o.default.div`
    ...
    top: 11px;
    right: 10px;
`;t.NumberInput=e=>{const[t,n]=r.useState(e.value||0),o=t=>{void 0!==e.min&&t<e.min&&(t=e.min),void 0!==e.max&&t>e.max&&(t=e.max),n(t),e.onChange(t)};let m=r.createElement(c,{onClick:()=>o(t-1)},r.createElement(a.FontAwesomeIcon,{icon:i.faMinus})),p=r.createElement(c,{onClick:()=>o(t+1)},r.createElement(a.FontAwesomeIcon,{icon:s.faPlus}));return void 0!==e.min&&e.value<=e.min&&(m=r.createElement(d,null,r.createElement(a.FontAwesomeIcon,{icon:i.faMinus}))),void 0!==e.max&&e.value>=e.max&&(p=r.createElement(d,null,r.createElement(a.FontAwesomeIcon,{icon:s.faPlus}))),r.createElement(u,null,r.createElement(l,{type:"text",value:t,onChange:e=>(e=>{const t=Number(e);o(Number.isSafeInteger(t)?t:0)})(e.target.value)}),r.createElement(h,null,m,p))}},1522:(e,t,n)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.RadioGroup=void 0;const r=n(8055),o=n(7625),i=n(7294),s=n(8804),a=s.default.div`
...
`,S=h.default.div`
    ...
    flex-direction: column;
    gap: 5px;
`,M=(0,h.default)(g.Button)`
    padding: 8px 10px;
`,I=(0,h.default)(g.Button)`
    flex-grow: 1;
`,R=h.default.div`
    display: flex;
    flex-direction: column;
...
`,P=h.default.div`
    display: flex;
    gap: 5px;
`,_=(0,o.observer)((({item:e})=>{const[t,n]=(0,s.useState)(!1),o=(0,s.useContext)(i.GenomeBankContext);if(t){const t=t=>{e.setName(t),o.put(e),n(!1)};return r.createElement(T,{value:e.getName(),onSave:t,onCancel:()=>n(!1)})}return e.getName().length>0?r.createElement(C,{onClick:()=>n(!0)},e.getName()):r.createElement(O,{onClick:()=>n(!0)},"No description.")})),T=(0,o.observer)((({value:e,onSave:t,onCancel:n})=>{const[o,i]=(0,s.useState)(e);return r.createElement(R,null,r.createElement(f.Textarea,{value:o,onChange:e=>i(e),placeholder:"Short description of this genome"}),r.createElement(P,null,r.createElement(g.Button,{width:"100%",apperance:"primary",onClick:()=>t(o)},"Save"),r.createElement(g.Button,{width:"100%",apperance:"secondary",onClick:()=>n()},"Cancel")))}));t.Item=(0,o.observer)((({item:e})=>{const t=(0,s.useContext)(i.GenomeBankContext),n=(0,s.useContext)(i.SimulationContext).getRenderer().getPaintMode();return r.createElement(E,null,r.createElement(x,null,r.createElement(w,null,r.createElement(p.Visualization,{genome:e.getGenome()})),r.createElement(S,null,r.createElement(M,{onClick:()=>{n.setClipboard(e.getGenome()),n.setType(y.CellType.ORGANISM),n.setEnabled(!0)}},r.createElement(m.FontAwesomeIcon,{icon:c.faEyeDropper})),r.createElement(M,{onClick:()=>{!function(e){const t=document.createElement("a"),n=window.URL.createObjectURL(new Blob([JSON.stringify(e.serialize())],{type:"octet/stream"}));t.href=n,t.setAttribute("download",e.getId()+".genome"),t.click(),window.URL.revokeObjectURL(n)}(e)}},r.createElement(m.FontAwesomeIcon,{icon:a.faDownload})),r.createElement(M,{onClick:()=>{t.delete(e)}},r.createElement(m.FontAwesomeIcon,{icon:l.faTrash})))),r.createElement(_,{item:e}))})),t.Genomes=(0,o.observer)((()=>{const e=(0,s.useContext)(i.GenomeBankContext);return r.createElement(r.Fragment,null,r.createElement(b,null,r.createElement(I,{apperance:"primary",onClick:()=>(()=>{const t=document.createElement("input");t.type="file",t.addEventListener("change",(()=>{for(const n of t.files)n.text().then((t=>{try{const n=JSON.parse(t);e.put(new v.GenomeItem(n.name,n.id,n.genome,+Date.now()))}catch(e){alert("File parsing error")}}))})),t.click()})()},r.createElement(m.FontAwesomeIcon,{icon:u.faUpload})," Import"),r.createElement(g.Button,{onClick:()=>e.refresh()},r.createElement(m.FontAwesomeIcon,{icon:d.faRotate}))),r.createElement(r.Fragment,null,e.getItems().map((e=>r.createElement(t.Item,{item:e,key:e.getId()})))))}))},4485:(e,t,n)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.Info=void 0;const r=n(7294),o=n(2766),i=n(1997),s=n(7294),a=n(8804),l=n(6724),c=a.default.div`
    display: flex;
    justify-content: space-between;
    margin-bottom: 6px;
`;t.Info=(0,o.observer)((()=>{const e=(0,s.useContext)(i.SimulationContext);return r.createElement(r.Fragment,null,r.createElement(c,null,r.createElement("span",null,"Size"),r.createElement("span",null,e.getWidth(),"×",e.getHeight())),r.createElement(c,null,r.createElement("span",null,"Step"),r.createElement("span",null,e.getCurrentStep())),r.createElement(c,null,r.createElement("span",null,"Step time"),r.createElement("span",null,e.getStepTime()," ms")),r.createElement(c,null,r.createElement("span",null,"Render time"),r.createElement("span",null,e.getRenderer().getRenderTime()," ms")),r.createElement(c,null,r.createElement("span",null,"Organisms count"),r.createElement("span",null,e.getOrganismsCount())),r.createElement(l.Legend,null))}))},6724:(e,t,n)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.Legend=void 0;const r=n(7294),o=n(8804),i=n(2766),s=n(1997),a=n(7294),l=n(5120),c=o.default.div`
    display: flex;
    margin-bottom: 6px;
`,d=o.default.div`
    margin-bottom: 10px;
...
`,b=i.default.div`
    ...
    flex-direction: column;
    gap: 5px;
`,E=(0,i.default)(p.Button)`
    padding: 8px 10px;
`,C=(0,i.default)(p.Button)`
    flex-grow: 1;
`;t.Item=(0,s.observer)((({item:e})=>{const t=(0,l.useContext)(a.SaveContext),n=(0,l.useContext)(a.AppContext);return o.createElement(v,null,o.createElement(y,{onClick:()=>r(void 0,void 0,void 0,(function*(){n.loadSimulation(yield t.getDump(e),e.getRenderMode())}))},o.createElement("div",null,new Date(e.getCreatedAt()).toLocaleString()),o.createElement("div",null,"Step: ",e.getStep())),o.createElement(b,null,o.createElement(E,{onClick:()=>{!function(e,t){r(this,void 0,void 0,(function*(){const n=document.createElement("a"),r=window.URL.createObjectURL(new Blob([JSON.stringify(yield t.serialize(e))],{type:"octet/stream"}));n.href=r,n.setAttribute("download",e.getId()+".save"),n.click(),window.URL.revokeObjectURL(r)}))}(e,t)}},o.createElement(m.FontAwesomeIcon,{icon:c.faDownload})),o.createElement(E,{onClick:()=>{t.delete(e)}},o.createElement(m.FontAwesomeIcon,{icon:d.faTrash}))))})),t.Saves=(0,s.observer)((()=>{const e=(0,l.useContext)(a.SaveContext),n=(0,l.useContext)(a.SimulationContext),r=(0,l.useContext)(a.AppContext),i=()=>{const t=document.createElement("input");t.type="file",t.addEventListener("change",(()=>{for(const n of t.files)n.text().then((t=>{try{const n=JSON.parse(t);e.addSave(new g.SaveItem(n.id,+Date.now(),n.step,n.renderMode,n.version),n.dump)}catch(e){alert("File parsing error")}}))})),t.click()};return o.createElement(o.Fragment,null,o.createElement(f,null,!r.getSimulation()&&o.createElement(o.Fragment,null,o.createElement(C,{apperance:"primary",onClick:()=>i()},o.createElement(m.FontAwesomeIcon,{icon:h.faUpload})," Import")),r.getSimulation()&&o.createElement(o.Fragment,null,o.createElement(C,{apperance:"primary",onClick:()=>n.save()},"Save"),o.createElement(p.Button,{onClick:()=>i()},o.createElement(m.FontAwesomeIcon,{icon:h.faUpload}))),o.createElement(p.Button,{onClick:()=>e.refresh()},o.createElement(m.FontAwesomeIcon,{icon:u.faRotate}))),o.createElement(o.Fragment,null,e.getItems().map((e=>o.createElement(t.Item,{item:e,key:e.getId()})))))}))},8477:(e,t,n)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.SelectedCell=void 0;const r=n(7294),o=n(2766),i=n(1997),s=n(7294),a=n(8360),l=n(8005),c=n(2841);t.SelectedCell=(0,o.observer)((()=>{const e=(0,s.useContext)(i.SimulationContext).getSelectedCell().getCell();return e&&e.type===c.CellType.ORGANISM?r.createElement(a.OrganismCell,null):r.createElement(l.UnselectedCell,null)}))},7244:(e,t,n)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.Simulation=void 0;const r=n(7294),o=n(8804),i=n(2766),s=n(4924),a=n(6852),l=n(7999),c=n(1997),d=o.default.div`
    height: 100%;
    width: 100%;
    display: flex;
    flex-direction: column;
    position: relative;
`;t.Simulation=(0,i.observer)((({simulation:e})=>r.createElement(c.SimulationContext.Provider,{value:e},e.isReady()&&r.createElement(d,null,r.createElement(l.Toolbar,null),r.createElement(a.Overlay,null),r.createElement(s.Viewport,null)))))},7999:(e,t,n)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.Toolbar=void 0;const r=n(7294),o=n(8804),i=n(2766),s=n(6700),a=n(9008),l=n(2384),c=n(7099),d=n(7382),u=n(2742),h=n(9073),m=n(9697),p=n(2722),g=n(7726),f=o.default.div`
    display: flex;
    align-items: stretch;
    width: 100%;
    overflow-x: auto;
...
`;t.ToolbarItem=(0,o.observer)((e=>r.createElement(i,Object.assign({},e))))},7099:(e,t,n)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.NewSimulationItem=void 0;const r=n(7294),o=n(2766),i=n(7294),s=n(3208),a=n(7625),l=n(1997),c=n(8421);t.NewSimulationItem=(0,o.observer)((()=>{const e=(0,i.useContext)(l.AppContext);return r.createElement(c.ToolbarItem,{onClick:()=>e.closeSimulation()},r.createElement(a.FontAwesomeIcon,{icon:s.faRotateRight}))}))},7382:(e,t,n)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.PaintModeItem=void 0;const r=n(7294),o=n(8804),i=n(2766),s=n(7294),a=n(869),l=n(7625),c=n(1997),d=n(8421),u=n(1421),h=n(5912),m=n(1752),p=n(1522),g=n(3540),f=n(9906),v=n(6989),y=n(2120),b=n(2841),E=n(7822),C=o.default.div`
    display: flex;
    align-items: center;
    padding: 0 5px;
