...
`;t.ReproductorOrgan=(0,o.observer)((({direction:e})=>n.createElement(s,{direction:e},n.createElement("img",{src:a.default}))))},7971:(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.SpineOrgan=void 0;const n=r(7294),o=r(2766),i=r(8804),a=r(4242),s=i.default.div`
    ...
    transform: rotate(${({direction:e})=>45*e}deg);
    z-index: 1;
`;t.SpineOrgan=(0,o.observer)((({direction:e})=>n.createElement(s,{direction:e},n.createElement("img",{src:a.default}))))},5221:(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.Program=void 0;const n=r(7294),o=r(2766),i=r(8804),a=r(2841),s=r(4766),l=r(2138),c=r(2197),u=r(3993),d=r(3007),m=r(6871),h=i.default.div`
    margin: 20px 0;
`,g=i.default.div`
    margin-bottom: 10px;
`,p=i.default.div`
...
`,y=(0,o.observer)((e=>e.command===a.Command.NOTHING?n.createElement(E,null):e.command===a.Command.GOTO?n.createElement(O,Object.assign({},e)):e.command===a.Command.SENSE?n.createElement(R,Object.assign({},e)):e.command===a.Command.ACTION?n.createElement(C,Object.assign({},e)):void 0)),b=(0,o.observer)((()=>n.createElement("span",null,"Invalid instruction"))),E=(0,o.observer)((()=>n.createElement("span",null,"Nothing"))),O=(0,o.observer)((({goto:e})=>n.createElement("span",null,"Goto line ",e))),C=(0,o.observer)((({organism:e,argument:t})=>{const r=(0,l.getOrganIndex)(t),o=(0,l.getParameter)(t),i=e.genome.organs[r];if(i===a.Organ.CHLOROPLAST)return n.createElement("span",null,"Photosynthesis");if(i===a.Organ.OXIDIZER)return n.createElement("span",null,"Chemosynthesis");if(i===a.Organ.FIN){const e=(0,m.getMovementTypeFromParameter)(o);if(e===m.MovementType.ROTATE_LEFT)return n.createElement("span",null,"Turn left");if(e===m.MovementType.ROTATE_RIGHT)return n.createElement("span",null,"Turn right");if(e===m.MovementType.MOVE_FORWARD)return n.createElement("span",null,"Move forward")}if(i===a.Organ.MOUTH){const e=(0,d.getPowerFromParameter)(o);return n.createElement("span",null,"Eat with power ",e)}return i===a.Organ.REPRODUCTOR?n.createElement("span",null,"Give birth to a child"):n.createElement(b,null)})),R=(0,o.observer)((({organism:e,argument:t,goto:r})=>{const o=(0,l.getOrganIndex)(t),i=(0,l.getParameter)(t),s=e.genome.organs[o];if(s===a.Organ.FERMENTER){const e=(0,c.getEnergyFromParameter)(i);return n.createElement("span",null,"Goto line ",r," if energy >= ",e)}if(s===a.Organ.EYE){const e=(0,u.getTargetFromParameter)(i);let t="";return e===u.TargetType.EMPTY?t="empty":e===u.TargetType.WALL?t="a wall":e===u.TargetType.ORGANIC?t="organics":e===u.TargetType.ORGANISM_SIMILAR?t="related organism":e===u.TargetType.ORGANISM_OTHER&&(t="alien organism"),n.createElement("span",null,"Goto line ",r," if the eye sees ",t)}return n.createElement(b,null)}));t.Program=(0,o.observer)((({organism:e})=>n.createElement(h,null,n.createElement(g,null,"Program"),n.createElement(p,null,(0,s.chunk)(e.genome.program,3).map((([t,r,o],i)=>n.createElement(f,{key:i},n.createElement(v,{active:i===e.programCounter},i),n.createElement(y,{organism:e,command:t,argument:r,goto:o}))))))))},5159:(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.Visualization=void 0;const n=r(7294),o=r(8804),i=r(2766),a=r(2841),s=r(346),l=r(3798),c=r(2920),u=r(1098),d=r(5498),m=r(7971),h=r(6373),g=r(5160),p=r(7386),f=r(3738),v=o.default.div`
    width: 200px;
    height: 200px;
    position: relative;
    margin: 0 auto;
`;t.Visualization=(0,i.observer)((({genome:e})=>n.createElement(v,null,n.createElement(s.Body,{color:e.color}),e.organs.map(((e,t)=>{switch(e){case a.Organ.ARMOUR:return n.createElement(l.ArmorOrgan,{key:t,direction:t});case a.Organ.FIN:return n.createElement(c.FinOrgan,{key:t,direction:t});case a.Organ.MOUTH:return n.createElement(u.MouthOrgan,{key:t,direction:t});case a.Organ.OXIDIZER:return n.createElement(d.OxidizerOrgan,{key:t,direction:t});case a.Organ.FERMENTER:return n.createElement(f.FermenterOrgan,{key:t,direction:t});case a.Organ.REPRODUCTOR:return n.createElement(p.ReproductorOrgan,{key:t,direction:t});case a.Organ.SPINE:return n.createElement(m.SpineOrgan,{key:t,direction:t});case a.Organ.CHLOROPLAST:return n.createElement(h.ChloroplastOrgan,{key:t,direction:t});case a.Organ.EYE:return n.createElement(g.EyeOrgan,{key:t,direction:t})}})))))},8005:(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.UnselectedCell=void 0;const n=r(7294),o=r(2766);t.UnselectedCell=(0,o.observer)((()=>n.createElement(n.Fragment,null,"Select a cell on the map")))},1752:(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.ContextMenu=t.ContextMenuItem=void 0;const n=r(7294),o=r(8804),i=o.default.div`
    display: flex;
    flex-direction: column;
    background: #202c3c;
    margin-top: 10px;
...
`;t.CreateSimulationForm=({options:e})=>{const t=(0,o.useContext)(s.RootStoreContext),[r,i]=(0,o.useState)(e.loop),[a,y]=(0,o.useState)(e.width),[b,E]=(0,o.useState)(e.height),[O,C]=(0,o.useState)(e.initialEnergy),[R,S]=(0,o.useState)(e.population),[x,w]=(0,o.useState)(e.lightDepth),[M,P]=(0,o.useState)(e.lightGradient),[I,T]=(0,o.useState)(e.mineralsDepth),[A,_]=(0,o.useState)(e.mineralsGradient),[L,k]=(0,o.useState)(e.programLength);return n.createElement(p,null,n.createElement(f,null,n.createElement(v,null,n.createElement(c.FormRow,{label:"Grid width"},n.createElement(u.NumberInput,{min:0,onChange:e=>y(e),value:a})),n.createElement(c.FormRow,{label:"Grid height"},n.createElement(u.NumberInput,{min:0,onChange:e=>E(e),value:b}))),n.createElement(c.FormRow,{label:"Loop"},n.createElement(m.Select,{onSelect:e=>i(e),options:g,value:r})),n.createElement(d.RangeRow,{label:"Program length",min:7,max:256,step:1,onChange:e=>k(e),value:L}),n.createElement(d.RangeRow,{label:"Initial population",postfix:"%",min:0,max:100,step:.1,onChange:e=>S(e),value:R}),n.createElement(d.RangeRow,{label:"Initial energy",min:0,max:255,step:1,onChange:e=>C(e),value:O}),n.createElement(d.RangeRow,{label:"Light depth",postfix:"%",min:0,max:100,step:.1,onChange:e=>w(e),value:x}),n.createElement(d.RangeRow,{label:"Minerals depth",postfix:"%",min:0,max:100,step:.1,onChange:e=>T(e),value:I}),n.createElement(h.Switch,{label:"Light gradient",value:M,onChange:e=>P(e)}),n.createElement(h.Switch,{label:"Minerals gradient",value:A,onChange:e=>_(e)})),n.createElement(l.Button,{apperance:"primary",width:"100%",onClick:()=>{t.newSimulation({loop:r,width:a,height:b,initialEnergy:O,population:R,lightDepth:x,lightGradient:M,mineralsDepth:I,mineralsGradient:A,programLength:L})}},"Create"))}},176:(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.Button=void 0;const n=r(2766),o=r(7294),i=r(8804),a=r(23),s={primary:{backgroundColor:a.THEME.primary,boderColor:a.THEME.primary,textColor:a.THEME.color},success:{backgroundColor:a.THEME.success,boderColor:a.THEME.success,textColor:a.THEME.color},secondary:{backgroundColor:a.THEME.secondary,boderColor:a.THEME.secondary,textColor:a.THEME.color}},l=i.default.button`
    border: 1px solid;
    border-radius: 10px;
    cursor: pointer;
    padding: 10px 16px;
...
`,m=o.default.div`
    ...
    top: 11px;
    right: 10px;
`;t.NumberInput=e=>{const[t,r]=n.useState(e.value||0),o=t=>{void 0!==e.min&&t<e.min&&(t=e.min),void 0!==e.max&&t>e.max&&(t=e.max),r(t),e.onChange(t)};let h=n.createElement(c,{onClick:()=>o(t-1)},n.createElement(s.FontAwesomeIcon,{icon:i.faMinus})),g=n.createElement(c,{onClick:()=>o(t+1)},n.createElement(s.FontAwesomeIcon,{icon:a.faPlus}));return void 0!==e.min&&e.value<=e.min&&(h=n.createElement(u,null,n.createElement(s.FontAwesomeIcon,{icon:i.faMinus}))),void 0!==e.max&&e.value>=e.max&&(g=n.createElement(u,null,n.createElement(s.FontAwesomeIcon,{icon:a.faPlus}))),n.createElement(d,null,n.createElement(l,{type:"text",value:t,onChange:e=>(e=>{const t=Number(e);o(Number.isSafeInteger(t)?t:0)})(e.target.value)}),n.createElement(m,null,h,g))}},1522:(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.RadioGroup=void 0;const n=r(8055),o=r(7625),i=r(7294),a=r(8804),s=a.default.div`
...
`,c=a.default.div`
    width: 20px;
`;t.RadioGroup=({choices:e,value:t,onChange:r})=>i.createElement(s,null,e.map(((e,a)=>i.createElement(l,{key:a,onClick:()=>r(e.value)},i.createElement(c,null,t===e.value&&i.createElement(o.FontAwesomeIcon,{icon:n.faCheck})),e.label))))},8863:(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.RangeInput=void 0;const n=r(7294),o=r(8804).default.input`
    width: 100%;
...
`,l=o.default.div`
    display: flex;
`;t.RangeRow=({label:e,postfix:t,min:r,max:o,step:c,value:u,onChange:d})=>n.createElement(i.FormRow,{label:e},n.createElement(l,null,n.createElement(a.RangeInput,{min:r,max:o,step:c,onChange:d,value:u}),n.createElement(s,null,u,t)))},1139:(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.Select=void 0;const n=r(7294),o=r(8804).default.select`
    background: ${e=>e.theme.secondary};
...
`;t.Switch=e=>n.createElement(i,null,n.createElement(a,{type:"checkbox",checked:e.value,onChange:t=>e.onChange(t.target.checked)}),n.createElement(s,null),n.createElement(l,null,e.label))},4070:(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.Textarea=void 0;const n=r(7294),o=r(8804).default.textarea`
    ...
    border-radius: 10px;
    color: ${e=>e.theme.color};
`;t.Textarea=({value:e,onChange:t,placeholder:r})=>n.createElement(o,{onChange:e=>t(e.target.value),value:e,placeholder:r})},617:(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.Genomes=t.Item=void 0;const n=r(7294),o=r(2766),i=r(7294),a=r(767),s=r(2619),l=r(4227),c=r(7608),u=r(2723),d=r(8804),m=r(7625),h=r(5159),g=r(176),p=r(4070),f=r(1065),v=r(2841),y=r(2718),b=d.default.div`
    display: flex;
    margin-bottom: 10px;
    gap: 5px;
`,E=d.default.div`
...
`,I=d.default.div`
    display: flex;
    gap: 5px;
`,T=(0,o.observer)((({item:e})=>{const[t,r]=(0,i.useState)(!1),o=(0,i.useContext)(y.RootStoreContext).getGenomeStore();if(t){const t=t=>{e.setName(t),o.put(e),r(!1)};return n.createElement(A,{value:e.getName(),onSave:t,onCancel:()=>r(!1)})}return e.getName().length>0?n.createElement(O,{onClick:()=>r(!0)},e.getName()):n.createElement(C,{onClick:()=>r(!0)},"No description.")})),A=(0,o.observer)((({value:e,onSave:t,onCancel:r})=>{const[o,a]=(0,i.useState)(e);return n.createElement(P,null,n.createElement(p.Textarea,{value:o,onChange:e=>a(e),placeholder:"Short description of this genome"}),n.createElement(I,null,n.createElement(g.Button,{width:"100%",apperance:"primary",onClick:()=>t(o)},"Save"),n.createElement(g.Button,{width:"100%",apperance:"secondary",onClick:()=>r()},"Cancel")))}));t.Item=(0,o.observer)((({item:e})=>{const t=(0,i.useContext)(y.RootStoreContext),r=t.getGenomeStore(),o=t.getSimulationStore().getRendererStore().getPaintMode();return n.createElement(E,null,n.createElement(R,null,n.createElement(S,null,n.createElement(h.Visualization,{genome:e.getGenome()})),n.createElement(x,null,n.createElement(w,{onClick:()=>{o.setClipboard(e.getGenome()),o.setType(v.CellType.ORGANISM),o.setEnabled(!0)}},n.createElement(m.FontAwesomeIcon,{icon:l.faEyeDropper})),n.createElement(w,{onClick:()=>{!function(e){const t=document.createElement("a"),r=window.URL.createObjectURL(new Blob([JSON.stringify(e.serialize())],{type:"octet/stream"}));t.href=r,t.setAttribute("download",e.getId()+".genome"),t.click(),window.URL.revokeObjectURL(r)}(e)}},n.createElement(m.FontAwesomeIcon,{icon:a.faDownload})),n.createElement(w,{onClick:()=>{r.delete(e)}},n.createElement(m.FontAwesomeIcon,{icon:s.faTrash})))),n.createElement(T,{item:e}))})),t.Genomes=(0,o.observer)((()=>{const e=(0,i.useContext)(y.RootStoreContext).getGenomeStore();return n.createElement(n.Fragment,null,n.createElement(b,null,n.createElement(M,{apperance:"primary",onClick:()=>(()=>{const t=document.createElement("input");t.type="file",t.addEventListener("change",(()=>{for(const r of t.files)r.text().then((t=>{try{const r=JSON.parse(t);e.put(new f.GenomeItem(r.name,r.id,r.genome,+Date.now()))}catch(e){alert("File parsing error")}}))})),t.click()})()},n.createElement(m.FontAwesomeIcon,{icon:u.faUpload})," Import"),n.createElement(g.Button,{onClick:()=>e.refresh()},n.createElement(m.FontAwesomeIcon,{icon:c.faRotate}))),n.createElement(n.Fragment,null,e.getItems().map((e=>n.createElement(t.Item,{item:e,key:e.getId()})))))}))},4485:(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.Info=void 0;const n=r(7294),o=r(2766),i=r(7294),a=r(8804),s=r(6724),l=r(7244),c=a.default.div`
    display: flex;
    justify-content: space-between;
    margin-bottom: 6px;
`;t.Info=(0,o.observer)((()=>{const{simulation:e}=(0,i.useContext)(l.SimulationContext);return n.createElement(n.Fragment,null,n.createElement(c,null,n.createElement("span",null,"Size"),n.createElement("span",null,e.getWidth(),"×",e.getHeight())),n.createElement(c,null,n.createElement("span",null,"Step"),n.createElement("span",null,e.getCurrentStep())),n.createElement(c,null,n.createElement("span",null,"Step time"),n.createElement("span",null,e.getStepTime()," ms")),n.createElement(c,null,n.createElement("span",null,"Render time"),n.createElement("span",null,e.getRendererStore().getRenderTime()," ms")),n.createElement(c,null,n.createElement("span",null,"Organisms count"),n.createElement("span",null,e.getOrganismsCount())),n.createElement(s.Legend,null))}))},6724:(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.Legend=void 0;const n=r(7294),o=r(8804),i=r(2766),a=r(7294),s=r(5120),l=r(7244),c=o.default.div`
    display: flex;
    margin-bottom: 6px;
`,u=o.default.div`
    margin-bottom: 10px;
...
`,d=o.default.div`
    ...
    margin-right: 10px;
`,m={default:[{label:"Organism",color:s.Colors.organism}],lifetime:[{label:"Older",color:s.Colors.lifetimeMin},{label:"Younger",color:s.Colors.lifetimeMax}],energy:[{label:"Less energy",color:s.Colors.energyMin},{label:"More energy",color:s.Colors.energyMax}],supply:[{label:"Uses organic",color:s.Colors.supplyOrganic},{label:"Uses photosynthesis",color:s.Colors.supplyPhotosynthesis},{label:"Uses chemosynthesis",color:s.Colors.supplyChemosynthesis}],genesis:[]};t.Legend=(0,i.observer)((()=>{const{renderer:e}=(0,a.useContext)(l.SimulationContext),t=e.getRenderMode();return n.createElement(n.Fragment,null,n.createElement(u,null,"Legend"),n.createElement(c,null,n.createElement(d,{bg:s.Colors.wall}),n.createElement("span",null,"Wall")),n.createElement(c,null,n.createElement(d,{bg:s.Colors.organic}),n.createElement("span",null,"Organic")),m[t].map(((e,t)=>n.createElement(c,{key:t},n.createElement(d,{bg:e.color}),n.createElement("span",null,e.label)))))}))},7366:(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.MainMenu=void 0;const n=r(2766),o=r(7294),i=r(7294),a=r(8804),s=r(711),l=r(8042),c=r(2821),u=a.default.div`
    display: flex;
    max-width: 900px;
    max-height: 600px;
    margin: auto;
...
`,h=a.default.button`
    ...
    color: #fff;
    border: none;
`;t.MainMenu=(0,n.observer)((()=>{const[e,t]=(0,i.useState)("new");return o.createElement(u,null,o.createElement(d,null,o.createElement(h,{active:"new"===e,onClick:()=>t("new")},"New simulation"),o.createElement(h,{active:"load"===e,onClick:()=>t("load")},"Load simulation")),o.createElement(m,null,"new"===e&&o.createElement(l.CreateSimulationForm,{options:(0,s.loadOptions)()}),"load"===e&&o.createElement(c.Saves,null)))}))},5912:(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.Overflow=void 0;const n=r(7294),o=r(7294),i=r(8804).default.div`
    position: fixed;
`;t.Overflow=({root:e,children:t,onLoseFocus:r})=>{const[a,s]=(0,o.useState)(0),[l,c]=(0,o.useState)(0),[u,d]=(0,o.useState)(!1),m=(0,o.useRef)();return(0,o.useEffect)((()=>{if(e&&m.current){const t=e.getBoundingClientRect();c(t.top+t.height),t.left+m.current.getBoundingClientRect().width>window.innerWidth?s(Math.max(0,window.innerWidth-m.current.getBoundingClientRect().width)):s(Math.max(0,t.left)),d(!0)}const t=t=>{e.contains(t.target)||r&&r()};return window.addEventListener("mousedown",t),()=>{window.removeEventListener("mousedown",t)}})),n.createElement(i,{style:{left:a,top:l,display:u?null:"none"},ref:m},t)}},6852:(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.Overlay=void 0;const n=r(7294),o=r(8804),i=r(2766),a=r(1936),s=r(7294),l=r(4485),c=r(8477),u=r(157),d=r(617),m=r(2821),h=r(7244),g=o.default.div`
    position: absolute;
    top: 50px;
    left: 0;
    bottom: 0;
...
`,f=o.default.div`
    ...
    width: 320px;
`;t.Overlay=(0,i.observer)((()=>{const{ui:e}=(0,s.useContext)(h.SimulationContext);return n.createElement(g,null,e.isInfoOpened()&&n.createElement(p,null,n.createElement(l.Info,null)),e.isTabActive(u.SidebarTab.PARAMERS)&&n.createElement(f,null,n.createElement(a.Parameters,null)),e.isTabActive(u.SidebarTab.CELL)&&n.createElement(f,null,n.createElement(c.SelectedCell,null)),e.isTabActive(u.SidebarTab.GENOMES)&&n.createElement(f,null,n.createElement(d.Genomes,null)),e.isTabActive(u.SidebarTab.SAVES)&&n.createElement(f,null,n.createElement(m.Saves,null)))}))},1936:(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.Parameters=void 0;const n=r(7294),o=r(2766),i=r(7294),a=r(9906),s=r(7244);t.Parameters=(0,o.observer)((()=>{const{parameters:e}=(0,i.useContext)(s.SimulationContext);return n.createElement(n.Fragment,null,n.createElement(a.RangeRow,{label:"Lifetime limit",min:1,max:255,step:1,onChange:t=>e.setOrganismMaxLifetime(t),value:e.getOrganismMaxLifetime()}),n.createElement(a.RangeRow,{label:"Photosynthesis energy",min:0,max:255,step:1,onChange:t=>e.setPhotosynthesisEnergy(t),value:e.getPhotosynthesisEnergy()}),n.createElement(a.RangeRow,{label:"Chemosynthesis energy",min:0,max:255,step:1,onChange:t=>e.setChemosynthesisEnergy(t),value:e.getChemosynthesisEnergy()}),n.createElement(a.RangeRow,{label:"Eat cost",min:0,max:255,step:1,onChange:t=>e.setEatCost(t),value:e.getEatCost()}),n.createElement(a.RangeRow,{label:"Divide cost",min:0,max:255,step:1,onChange:t=>e.setDivideCost(t),value:e.getDivideCost()}),n.createElement(a.RangeRow,{label:"Simulation step cost",min:0,max:255,step:1,onChange:t=>e.setStepCost(t),value:e.getStepCost()}),n.createElement(a.RangeRow,{label:"Attack cost rate",postfix:"%",min:0,max:100,step:1,onChange:t=>e.setAttackCostRate(t),value:e.getAttackCostRate()}),n.createElement(a.RangeRow,{label:"Spine damage rate",postfix:"%",min:0,max:100,step:1,onChange:t=>e.setSpineDamageRate(t),value:e.getSpineDamageRate()}),n.createElement(a.RangeRow,{label:"Armour protection rate",postfix:"%",min:0,max:100,step:1,onChange:t=>e.setArmourProtectionRate(t),value:e.getArmourProtectionRate()}),n.createElement(a.RangeRow,{label:"Mutation program rate",postfix:"%",min:0,max:100,step:1,onChange:t=>e.setMutationProgramRate(t),value:e.getMutationProgramRate()}),n.createElement(a.RangeRow,{label:"Mutation base organs rate",postfix:"%",min:0,max:100,step:1,onChange:t=>e.setMutationBaseOrgansRate(t),value:e.getMutationBaseOrgansRate()}),n.createElement(a.RangeRow,{label:"Mutation limb organs rate",postfix:"%",min:0,max:100,step:1,onChange:t=>e.setMutationLimbOrgansRate(t),value:e.getMutationLimbOrgansRate()}))}))},2821:function(e,t,r){var n=this&&this.__awaiter||function(e,t,r,n){return new(r||(r=Promise))((function(o,i){function a(e){try{l(n.next(e))}catch(e){i(e)}}function s(e){try{l(n.throw(e))}catch(e){i(e)}}function l(e){var t;e.done?o(e.value):(t=e.value,t instanceof r?t:new r((function(e){e(t)}))).then(a,s)}l((n=n.apply(e,t||[])).next())}))};Object.defineProperty(t,"__esModule",{value:!0}),t.Saves=t.Item=void 0;const o=r(7294),i=r(8804),a=r(2766),s=r(7294),l=r(767),c=r(2619),u=r(7608),d=r(2723),m=r(7625),h=r(176),g=r(4025),p=r(2718),f=i.default.div`
    display: flex;
    margin-bottom: 10px;
    gap: 5px;
`,v=i.default.div`
...
`,b=i.default.div`
    ...
    flex-direction: column;
    gap: 5px;
`,E=(0,i.default)(h.Button)`
    padding: 8px 10px;
`,O=(0,i.default)(h.Button)`
    flex-grow: 1;
`,C=i.default.div`
    display: flex;
    flex-direction: column;
...
`,R=i.default.div`
    ...
    overflow-y: auto;
    padding-right: 10px;
`;t.Item=(0,a.observer)((({item:e})=>{const t=(0,s.useContext)(p.RootStoreContext),r=t.getSaveStore();return o.createElement(v,null,o.createElement(y,{onClick:()=>n(void 0,void 0,void 0,(function*(){t.loadSimulation(yield r.getDump(e),e.getRenderMode())}))},o.createElement("div",null,new Date(e.getCreatedAt()).toLocaleString()),o.createElement("div",null,"Step: ",e.getStep())),o.createElement(b,null,o.createElement(E,{onClick:()=>{!function(e,t){n(this,void 0,void 0,(function*(){const r=document.createElement("a"),n=window.URL.createObjectURL(new Blob([JSON.stringify(yield t.serialize(e))],{type:"octet/stream"}));r.href=n,r.setAttribute("download",e.getId()+".save"),r.click(),window.URL.revokeObjectURL(n)}))}(e,r)}},o.createElement(m.FontAwesomeIcon,{icon:l.faDownload})),o.createElement(E,{onClick:()=>{r.delete(e)}},o.createElement(m.FontAwesomeIcon,{icon:c.faTrash}))))})),t.Saves=(0,a.observer)((()=>{const e=(0,s.useContext)(p.RootStoreContext),r=e.getSaveStore(),n=e.getSimulationStore(),i=()=>{const e=document.createElement("input");e.type="file",e.addEventListener("change",(()=>{for(const t of e.files)t.text().then((e=>{try{const t=JSON.parse(e);r.addSave(new g.SaveItem(t.id,+Date.now(),t.step,t.renderMode,t.version),t.dump)}catch(e){alert("File parsing error")}}))})),e.click()};return o.createElement(C,null,o.createElement(f,null,!e.getSimulationStore()&&o.createElement(o.Fragment,null,o.createElement(O,{apperance:"primary",onClick:()=>i()},o.createElement(m.FontAwesomeIcon,{icon:d.faUpload})," Import")),e.getSimulationStore()&&o.createElement(o.Fragment,null,o.createElement(O,{apperance:"primary",onClick:()=>n.save()},"Save"),o.createElement(h.Button,{onClick:()=>i()},o.createElement(m.FontAwesomeIcon,{icon:d.faUpload}))),o.createElement(h.Button,{onClick:()=>r.refresh()},o.createElement(m.FontAwesomeIcon,{icon:u.faRotate}))),o.createElement(R,null,r.getItems().map((e=>o.createElement(t.Item,{item:e,key:e.getId()})))))}))},8477:(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.SelectedCell=void 0;const n=r(7294),o=r(2766),i=r(7294),a=r(8360),s=r(8005),l=r(2841),c=r(7244);t.SelectedCell=(0,o.observer)((()=>{const{selectedCell:e}=(0,i.useContext)(c.SimulationContext),t=e.getCell();return t&&t.type===l.CellType.ORGANISM?n.createElement(a.OrganismCell,null):n.createElement(s.UnselectedCell,null)}))},7244:(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.Simulation=t.SimulationContext=void 0;const n=r(7294),o=r(8804),i=r(2766),a=r(4924),s=r(6852),l=r(7999),c=r(7294),u=o.default.div`
    height: 100%;
    width: 100%;
    display: flex;
    flex-direction: column;
    position: relative;
`;t.SimulationContext=(0,c.createContext)({simulation:null,ui:null,renderer:null,selectedCell:null,parameters:null}),t.Simulation=(0,i.observer)((({simulation:e})=>{const r={simulation:e,ui:e.getUI(),renderer:e.getRendererStore(),selectedCell:e.getSelectedCell(),parameters:e.getParameters()};return n.createElement(t.SimulationContext.Provider,{value:r},e.isReady()&&n.createElement(u,null,n.createElement(l.Toolbar,null),n.createElement(s.Overlay,null),n.createElement(a.Viewport,null)))}))},7999:(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.Toolbar=void 0;const n=r(7294),o=r(8804),i=r(2766),a=r(6700),s=r(9008),l=r(2384),c=r(7099),u=r(7382),d=r(2742),m=r(9073),h=r(9697),g=r(2722),p=r(7726),f=r(2972),v=o.default.div`
    display: flex;
    align-items: stretch;
    width: 100%;
    overflow-x: auto;
...
`;t.Toolbar=(0,i.observer)((()=>n.createElement(v,null,n.createElement(y,{justify:"flex-start"},n.createElement(d.ParametersItem,null),n.createElement(h.CellItem,null),n.createElement(g.GenomesItem,null),n.createElement(p.SavesItem,null)),n.createElement(y,{justify:"center"},n.createElement(a.StartPauseItem,null),n.createElement(s.StepItem,null),n.createElement(f.SpeedItem,null),n.createElement(c.NewSimulationItem,null)),n.createElement(y,{justify:"flex-end"},n.createElement(l.RenderModeItem,null),n.createElement(u.PaintModeItem,null),n.createElement(m.InfoItem,null)))))},9697:(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.CellItem=void 0;const n=r(7294),o=r(2766),i=r(7294),a=r(2922),s=r(7625),l=r(8421),c=r(157),u=r(7244);t.CellItem=(0,o.observer)((()=>{const{ui:e}=(0,i.useContext)(u.SimulationContext);return n.createElement(l.ToolbarItem,{onClick:()=>e.toggleTab(c.SidebarTab.CELL),enabled:e.isTabActive(c.SidebarTab.CELL)},n.createElement(s.FontAwesomeIcon,{icon:a.faMicroscope}))}))},2722:(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.GenomesItem=void 0;const n=r(7294),o=r(2766),i=r(7294),a=r(7093),s=r(7625),l=r(8421),c=r(157),u=r(7244);t.GenomesItem=(0,o.observer)((()=>{const{ui:e}=(0,i.useContext)(u.SimulationContext);return n.createElement(l.ToolbarItem,{onClick:()=>e.toggleTab(c.SidebarTab.GENOMES),enabled:e.isTabActive(c.SidebarTab.GENOMES)},n.createElement(s.FontAwesomeIcon,{icon:a.faDna}))}))},9073:(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.InfoItem=void 0;const n=r(7294),o=r(2766),i=r(7294),a=r(8099),s=r(7625),l=r(8421),c=r(7244);t.InfoItem=(0,o.observer)((()=>{const{ui:e}=(0,i.useContext)(c.SimulationContext);return n.createElement(l.ToolbarItem,{onClick:()=>e.setInfoOpened(!e.isInfoOpened()),enabled:e.isInfoOpened()},n.createElement(s.FontAwesomeIcon,{icon:a.faInfo}))}))},8421:(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.ToolbarItem=void 0;const n=r(7294),o=r(2766),i=r(8804).default.div`
    user-select: none;
    display: flex;
    align-items: center;
...
`;t.ToolbarItem=(0,o.observer)((e=>n.createElement(i,Object.assign({},e))))},7099:(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.NewSimulationItem=void 0;const n=r(7294),o=r(2766),i=r(7294),a=r(3208),s=r(7625),l=r(8421),c=r(2718);t.NewSimulationItem=(0,o.observer)((()=>{const e=(0,i.useContext)(c.RootStoreContext);return n.createElement(l.ToolbarItem,{onClick:()=>e.closeSimulation()},n.createElement(s.FontAwesomeIcon,{icon:a.faRotateRight}))}))},7382:(e,t,r)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.PaintModeItem=void 0;const n=r(7294),o=r(8804),i=r(2766),a=r(7294),s=r(869),l=r(7625),c=r(8421),u=r(1421),d=r(5912),m=r(1752),h=r(1522),g=r(3540),p=r(9906),f=r(6989),v=r(176),y=r(2841),b=r(7822),E=r(7244),O=o.default.div`
    display: flex;
    align-items: center;
    padding: 0 5px;
